...
1. **Find the active sprint file** — `Glob` `docs/project/sprints/*/tasks.md`, pick the one whose header marks it active (or the one referenced by `docs/project/sprints/S<N>/tasks.md`).
