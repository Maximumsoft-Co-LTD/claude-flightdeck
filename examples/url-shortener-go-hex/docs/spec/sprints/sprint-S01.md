...
> **Retro:** [`../sprints/S01/retro.md`](../sprints/S01/retro.md)
...
|----|-------|------|------|-------|------------|---------------------------------------------------------------|--------|
| URLSH-S01.01 | Hex skeleton + `cmd/server` wiring | feat | M | @alice | [`D001`](../../project/sprints/S01/designs/D001-hex-skeleton.md) | `go build ./...` green; ports & adapters dirs exist; `Wire()` boots | [x] Done |
...
| URLSH-S01.04 | First redirect handler — `POST /shorten` + `GET /{code}` | feat | L | @alice | [`D003`](../../project/sprints/S01/designs/D003-first-redirect-handler.md) | E2E: shorten → 201 with `code`; redirect → 308 to original URL | [x] Done |
...
- [x] All 5 tasks have a row in [`../sprints/S01/retro.md`](../sprints/S01/retro.md) per-task summary
