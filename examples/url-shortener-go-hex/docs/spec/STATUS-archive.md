...
single-pane glance. `docs/project/sprints/S<N>/tasks.md` is the per-task
detail. `docs/project/sprints/S<N>/retro.md` is the per-sprint retro.
...
- Links to `docs/project/sprints/S<N>/tasks.md` and
  `docs/project/sprints/S<N>/retro.md` for detail.
...
- See [`sprints/S02/tasks.md`](./sprints/S02/tasks.md) for the task table.
- See [`sprints/S02/retro.md`](./sprints/S02/retro.md) for the retro (Aged-L201 lesson, A012 promoted, 1 follow-up consumed, 2 new opened).
...
- See [`sprints/S01/tasks.md`](./sprints/S01/tasks.md) for the task table.
- See [`sprints/S01/retro.md`](./sprints/S01/retro.md) for the retro (proposed A011 "every endpoint commits with a smoke test in the same PR" — formally promoted at the close of S02).
